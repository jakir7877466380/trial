...
def hero():
    ...
    Firstend = now.replace(hour=14, minute=36, second=0, microsecond=0)
    i=0
    while(y):
        now = datetime.datetime.now()
        if(now < First):
...
if(expirydate>today):
    ...
    while(True):
        ...
        if(bhai==code or bhai==test or bhai==code1 or bhai==code2):
            ...
            print("27th May 2022, 02:30 PM - 03:00 PM")
            print("27th May 2022, 05:30 PM- 06:00 PM")
            print("27th May 2022, 08:30 PM- 09:00 PM")
